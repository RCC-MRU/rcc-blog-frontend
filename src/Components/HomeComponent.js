          ...
          <div className="col-12 col-md-6 my-1 px-1">
            <div className="banner-img-left">
              <div className="centered">
                <button className="btn btn-black btn-sm text-white">workout</button>
          ...
          <div className="col-12 col-sm-3 d-flex justify-content-center">
            <div className="card border-0">
              ...
              <div className="card-body text-center">
                <h4 className="card-title format-text-popular">Fitness</h4>
                <p className="card-text format-text-para">Lorem Ipsum dolor</p>
              </div>
            </div>
          </div>
          <div className="col-12 col-sm-3 d-flex justify-content-center">
        ...
        <div className="row">
          ...
          <div className="col-12 col-md-4 my-1">
            ...
            <div className="footer-connect-text">
              ...
              <div className="footer-icon-gap">
                <i className="fa fa-phone-alt fa-lg mr-3"></i> +91 - 9812345678
              </div>
              <div className="footer-icon-gap">
